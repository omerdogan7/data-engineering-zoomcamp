...
```bash SELECT COUNT(*)
FROM public.yellow_taxi_trips_2019_10 
where trip_distance "above conditions" 
```
Answers:
...
FROM public.yellow_taxi_trips_2019_10 t
...
FROM public."yellow_taxi_trips_2019_10" t
JOIN public."zones" z_pickup ON t."PULocationID" = z_pickup."LocationID"
JOIN public."zones" z_drop ON t."DOLocationID" = z_drop."LocationID"
